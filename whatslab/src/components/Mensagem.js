...
class Mensagem extends React.Component {
  ...
  adicionarMensagem=()=>{
    ...
    this.setState({
      mensagens: [...this.state.mensagens, novaMensagem], nomeRemetente: "", conteudoDaMensagem: ""
  ...
  render() {
    ...
    return (
        <MensagemContainer>
          ...
          <InputConteudo type="text" placeholder={'Escreva sua Mensagem'} onChange={this.onChangeConteudo} value={this.state.inputConteudo} />
